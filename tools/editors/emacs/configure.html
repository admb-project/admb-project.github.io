...
**The .emacs file**
General information about the .emacs file is provided in the [Install](install.html) notes and sections of the [Emacs manual](http://www.gnu.org/software/emacs/manual/html_node/emacs/Init-File.html), [Emacs Lisp manual](http://www.gnu.org/software/emacs/manual/html_node/elisp/Init-File.html), [Chassel's tutorial](http://www.gnu.org/software/emacs/emacs-lisp-intro/html_node/Emacs-Initialization.html), and [EmacsWiki](http://emacswiki.org/emacs/InitFile).
...
The hefty PDF versions of the [Emacs manual](http://www.gnu.org/software/emacs/manual/emacs.pdf), [Emacs Lisp manual](http://www.gnu.org/software/emacs/manual/elisp.pdf), and [Chassel's tutorial](http://www.gnu.org/software/emacs/emacs-lisp-intro/emacs-lisp-intro.pdf) describe the Emacs Lisp language in great detail. Download them and use as an overview and reference when something is confusing.
